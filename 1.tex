...
\section{Результаты расчетов}
    ...
    % We apply the exact and asymptotic formulae obtained in the previous sections to electronic IFG with $g = 2$, $m_r = 1$. In figure~\ref{fig:chemical_potential} we illustrate the dependencies of chemical potential (a) and pressure (b) on temperature along three isochores. Chemical potential tends to $\varepsilon_F$ at $T\to 0$ and rapidly decreases and becomes negative at high temperatures. 
    На графике \ref{fig:chemical_potential} проиллюстрированы химический потенциал (а) и давление (б) на трех изохорах, полученные численно применением полученных выше формул с параметрами $g = 2$, $m_r = 1$.
    Видно, что химический потенциал стремится к $\epsilon_F$ при $T \to 0$ и быстро убывает в сторону отрицательных значений с повышением температуры.

    \begin{figure}[ht]
        % TODO: (a.kozharin) hspace! <- Mon Jun 22 15:42:48 2020
        \hspace{-1cm}
        \begin{subfigure}{0.5\columnwidth}
          \centering\includegraphics[width=\textwidth]{img/mu}
          \caption{}
        \end{subfigure}
        \begin{subfigure}{0.5\columnwidth}
          ...
          \caption{}
        \end{subfigure}
      \caption{Химический потенциал (a) и давление (б) \acrshort{ifg} на трех изохорах.}
      \label{fig:chemical_potential}
    \end{figure}

    %Isochoric and isobaric heat capacities vs. temperature are shown in figure~\ref{fig:heat_capacity}. At low temperatures both $C_V$ and $C_P$ demonstrate a linear temperature dependence. $C_P$ and $C_V$ can be distinguished at low temperatures only if we consider the terms proportional to $T^3$ \cite{Landau:statmech:1958} while the low-temperature approximation (\ref{eq:F_lt}) contains only the quadratic term. At high temperatures $C_V\to 3/2$ and $C_P\to 5/2$.
    Теплоемкости при постоянном объеме и давлении показаны на графике \ref{fig:heat_capacity}.
    При низких температурах оба $C_V$ и $C_P$ линейно зависят от температуры ---~ их различия проявляются только в членах, пропорциональных $T^3$ \cite{Landau:statmech:1958}.
    На высоких температурах $C_V \to 3/2$ и $C_P \to 5/2$.

    \begin{figure}[ht]
        % TODO: (a.kozharin) hspace <- Mon Jun 22 15:43:16 2020
        \hspace{-2cm}
      \centering\includegraphics[width=0.6\columnwidth]{img/cv_cp}
      \caption{Теплоемкости при постоянном объеме и давлении \acrshort{ifg} на трех изохорах.}
      \label{fig:heat_capacity}
    \end{figure}

    % Heat capacity ratio and adiabatic sound velocity can be seen in figure~\ref{fig:sound_velocity}. Again, we consider three isochores $v = 0.1$, 1 and 10. Heat capacity ratio $C_P / C_V$ is not constant for IFG and tends to a volume-dependent value at $T\to 0$. At high temperatures $C_P / C_V$ tends to a universal classical value $5/3$. Adiabatic sound velocity shows similar behavior; at high temperatures it tends to a volume-independent value $5/3T$. 
    % NOTE: вот тут я аккуратно подогнал размеры, чтобы последняя картинка не уехала на следующую страницу. Редактируйте с осторожностью.
    Отношение $C_P/C_V$ и адиабатическую скорость звука можно найти на графике \ref{fig:sound_velocity} в виде тех же трех изохор $v = 0.1$, $1$ и $10$.
    Заметим, что $C_P/C_V$ не является константой для \acrshort{ifg} и стремится к зависящему от $v$ значению при $T \to 0$.
    %Напротив, при высоких температурах это отношение стремится к классическому $5/3$ для всех $v$.
    Адиабатическая скорость звука проявляет схожее проведение; при высоких $T$ она стремится к независящему от объема значению $5/3T$.
    \begin{figure}[ht]
        % TODO: (a.kozharin) hspace! <- Mon Jun 22 15:43:30 2020
        \hspace{-1cm}
        \begin{subfigure}{0.5\columnwidth}
          \includegraphics[width=\textwidth]{img/cp_by_cv}
          \caption{}
        \end{subfigure}
        \begin{subfigure}{0.5\columnwidth}
          \includegraphics[width=\textwidth]{img/cs}
          \caption{}
        \end{subfigure}
      \caption{
          Отношение теплоемкостей (a) и адиабатическая скорость звука (б) \acrshort{ifg} на трех изохорах. 
      }
